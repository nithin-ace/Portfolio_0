    ...
    <div style={{ width: '100%', height: '600px', position: 'relative', overflow: 'hidden' }}>
      ...
      <AnimatePresence>
        {selected && (
          ...
          >
            <div style={{ fontSize: '0.65rem', opacity: 0.5, marginBottom: '0.5rem', letterSpacing: '0.2em' }}>NODE_ID: {selected.name}</div>
            <div style={{ fontSize: '1.2rem', fontWeight: 700, marginBottom: '1rem', borderBottom: '1px solid #333', paddingBottom: '0.5rem' }}>Sub-Skill Inventory</div>
            <div style={{ fontSize: '0.9rem', lineHeight: 1.6, fontFamily: 'monospace', color: '#ccc' }}>
